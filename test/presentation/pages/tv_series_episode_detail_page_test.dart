...
void main() {
  group('TvSeriesEpisodeDetailPage Widget Test', () {
    ...
    testWidgets('menampilkan detail episode dengan gambar', (
      WidgetTester tester,
    ) async {
      await mockNetworkImagesFor(() async {
        await tester.pumpWidget(
          MaterialApp(home: TvSeriesEpisodeDetailPage(episode: episode)),
        );
        await tester.pumpAndSettle();
        expect(
          find.text('Episode 1'),
          findsWidgets,
        ); // judul bisa muncul lebih dari sekali
        expect(find.text('Deskripsi episode 1'), findsOneWidget);
        expect(find.byType(Image), findsOneWidget);
      });
    });

    testWidgets('menampilkan icon jika tidak ada gambar', (
      WidgetTester tester,
    ) async {
      ...
      await tester.pumpWidget(
        MaterialApp(home: TvSeriesEpisodeDetailPage(episode: episodeNoImage)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets(
      'tap back button pada episode detail kembali ke halaman sebelumnya',
