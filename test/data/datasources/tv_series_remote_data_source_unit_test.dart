...
void main() {
  group('TvSeriesRemoteDataSourceImpl', () {
    ...
    test('getPopularTvSeries returns list when response 200', () async {
      ...
      when(mockHttpClient.get(argThat(isA<Uri>()))).thenAnswer((_) async => http.Response(responseJson, 200));
    ...
    test('getPopularTvSeries throws Exception on error', () async {
      when(mockHttpClient.get(argThat(isA<Uri>()))).thenAnswer((_) async => http.Response('error', 404));
