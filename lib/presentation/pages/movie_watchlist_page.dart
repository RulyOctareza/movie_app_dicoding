...
class MovieWatchlistPage extends StatelessWidget {
  ...
  const MovieWatchlistPage({super.key, required this.watchlist, required this.onRemove, required this.onTapDetail});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: watchlist.isEmpty
          ? const Center(child: Text('No movies in watchlist', style: TextStyle(color: Colors.white)))
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(movie.releaseDate ?? '-', style: const TextStyle(color: Colors.white70)),
                    trailing: IconButton(
